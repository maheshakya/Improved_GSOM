...
class Matrix {
    ...
    /**
     * Test code for SVD. Uses example from MIT video:
     * http://www.youtube.com/watch?v=cOUTpqlX-Xs
     */
...
//    }
    ...
    /**
     * Determines the eigenvalues and eigenvectors of a matrix by using the QR
     * algorithm. Repeats until no eigenvalue changes by more than 1/100000.
     *
     * @param	input	input matrix; must be square
     * @return	an EigenSet containing the eigenvalues and corresponding
     * eigenvectors of input
     */
    ...
    /**
     * Converts the input list of vectors into an orthonormal list with the same
     * span.
     *
    ...
    /**
     * Returns the matrix product of a and b; if the horizontal length of a is
     * not equal to the vertical length of b, throws an exception.
     *
     * @param a	double[][] matrix of values
     * @param b	double[][] matrix of values
    ...
    /**
     * Returns a normalized version of the input vector, i.e. vec scaled such
     * that ||vec|| = 1.
     *
     * @return	vec/||vec||
     */
...
/**
 * Data holder class that contains a set of eigenvalues and their corresponding
 * eigenvectors.
 *
 * @author	Kushal Ranjan
 * @version 051413
