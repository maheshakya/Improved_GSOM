...
/**
 * Performs principal component analysis on a set of data and returns the
 * resulting data set. The QR algorithm is used to find the eigenvalues and
 * orthonormal eigenvectors of the covariance matrix of the data set. The
 * eigenvectors corresponding to the largest eigenvalues are the principal
 * components. The data file should be in the same directory as the PCA.class
 * file. All numbers should be tab-delimited. The first line of the data should
 * be two numbers: the number of rows R followed by the number of columns C.
 * After that, there should be R lines of C tab-delimited values. The columns
 * would most likely represent the dimensions of measure; the rows would each
...
public class PCA {
    ...
    /**
     * Performs PCA on a set of data and prints the resulting transformed data
     * set.
     *
     * @param args	args[0] is the name of the file containing the data. args[1]
     * is an integer giving the number of desired principal components.
     */
...
//    }
    /**
     * Uses the file given by filename to construct a table for use by the
     * application. All numbers should be tab-delimited. The first line of the
     * data should be two numbers: the number of rows R followed by the number
     * of columns C. After that, there should be R lines of C tab-delimited
     * values.
     *
    ...
    /**
     * Saves the results of PCA to a file. The filename has "_processed"
