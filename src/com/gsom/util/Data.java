 ...
 * Primary computations of PCA are performed by the Data object.
 *
...
public class Data {
     ...
     *
     * @param vals	data for new Data object; dimensions as columns, data points
     * as rows.
     */
    Data(double[][] vals) {
    ...
    /**
     * Test code. Constructs an arbitrary data table of 5 data points with 3
     * variables, normalizes it, and computes the covariance matrix and its
     * eigenvalues and orthonormal eigenvectors. Then determines the two
...
//    }
    /**
     * PCA implemented using the NIPALS algorithm. The return value is a
     * double[][], where each double[] j is an array of the scores of the jth
     * data point corresponding to the desired number of principal components.
     *
    ...
    /**
     * Implementation of the non-linear iterative partial least squares
     * algorithm on the data matrix for this Data object. The number of PCs
     * returned is specified by the user.
     *
     * @param numComponents	number of principal components desired
     * @return	a double[][][] where the ith double[][] contains ti and pi, the
     * scores and loadings, respectively, of the ith principal component.
     */
     ...
     */
    /**
     * Performs principal component analysis with a specified number of
     * principal components.
     *
     * @param input	input data; each double[] in input is an array of values of
     * a single variable for each data point
    ...
    /**
     * Returns a list containing the principal components of this data set with
     * the number of loadings specified.
     *
    ...
    /**
     * Uses the QR algorithm to determine the eigenvalues and eigenvectors of
     * the covariance matrix for this data set. Iteration continues until no
     * eigenvalue changes by more than 1/10000.
     *
     * @return	an EigenSet containing the eigenvalues and eigenvectors of the
     * covariance matrix
     */
